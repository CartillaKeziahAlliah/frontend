...
const CreateExam = ({ selectedSubject }) => {
  ...
  const [previewVisible, setPreviewVisible] = useState(false); // State for preview visibility

  const errorRefs = useRef([]); // Array of refs to store references to question sections
